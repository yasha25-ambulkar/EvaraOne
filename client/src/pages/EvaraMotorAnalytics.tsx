...
const EvaraMotorAnalytics = () => {
  ...
  const renderWaterLevelVolumeCard = () => (
  ...
  const renderBuildingVisualCard = () => (
  ...
  const renderWaterLevelTrendCard = () => (
  ...
  const renderCurrentConsumptionCard = () => (
  ...
  return (
    <div className="min-h-screen bg-transparent font-sans relative overflow-x-hidden" style={{ color: 'var(--text-primary)' }}>
      ...
      <div className="grid lg:hidden grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <div className="col-span-1 flex flex-col gap-6">
          {renderMotorStatusCard()}
        </div>
        <div className="col-span-1 flex flex-col gap-6">
          {renderWaterLevelVolumeCard()}
          {renderMotorMonitorCard()}
        </div>
        <div className="col-span-1 md:col-span-2">
          {renderBuildingVisualCard()}
        </div>
        <div className="col-span-1 flex flex-col">{renderWaterLevelTrendCard()}</div>
        <div className="col-span-1 flex flex-col">{renderCurrentConsumptionCard()}</div>
        <div className="col-span-1 flex flex-col">{renderTodaysSummaryCard()}</div>
        <div className="col-span-1 flex flex-col">{renderRecentAlarmsCard()}</div>
      </div>
      ...
      <div className="hidden lg:grid grid-cols-12 gap-6 mt-6">
        ...
        <div className="col-span-12 lg:col-span-3 flex flex-col gap-6">
          {renderMotorMonitorCard()}
          {renderWaterLevelTrendCard()}
        </div>
        <div className="col-span-12 lg:col-span-6 grid grid-cols-1 md:grid-cols-1 gap-6">
          {renderCurrentConsumptionCard()}
        </div>
        <div className="col-span-12 lg:col-span-3">
          {renderTodaysSummaryCard()}
        </div>
        <div className="col-span-12 lg:col-span-3">
          {renderRecentAlarmsCard()}
        </div>
      </div>
      </main>
    </div>
