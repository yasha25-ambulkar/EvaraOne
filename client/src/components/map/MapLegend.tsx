    ...
    <div className="absolute bottom-6 left-6 z-[1000] flex flex-col items-start pointer-events-none">
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M12 5.5L7 8L12 10.5L17 8L12 5.5Z"
            fill="#fbbf24"
            stroke="#d97706"
            strokeWidth="1"
            strokeLinecap="round"
          ...
          />
          <path
            d="M12 2.5L2.5 7L12 11.5L21.5 7L12 2.5Z"
