...
const EvaraTankAnalytics = React.lazy(
  () => import("./pages/EvaraTankAnalytics"),
);
const EvaraDeepAnalytics = React.lazy(
  () => import("./pages/EvaraDeepAnalytics"),
);
const EvaraFlowAnalytics = React.lazy(
  () => import("./pages/EvaraFlowAnalytics"),
);
const EvaraTDSAnalytics = React.lazy(() => import("./pages/EvaraTDSAnalytics"));
const EvaraMotorAnalytics = React.lazy(
  () => import("./pages/EvaraMotorAnalytics"),
);
const EvaraValveAnalytics = React.lazy(
  () => import("./pages/EvaraValveAnalytics"),
);
...
const CustomerDetails = React.lazy(
  () => import("./pages/admin/hierarchy/CustomerDetails"),
);
const ZonesOverview = React.lazy(
  () => import("./pages/admin/hierarchy/ZonesOverview"),
);

const ZoneCustomers = React.lazy(
  () => import("./pages/admin/hierarchy/ZoneCustomers"),
);
                      ...
                      <Routes>
                        ...
                        <Route element={<ProtectedRoute />}>
                          <Route element={<MainLayout />}>
                            ...
                            <Route
                              path="/configure/:id"
                              element={<ConfigureNode />}
                            />
                            <Route
                              path="/configure-flow/:id"
                              element={<ConfigureFlow />}
                            />
                            <Route
                              path="/evaratank"
                              element={<EvaraTankAnalytics />}
                            />
                            <Route
                              path="/evaratank/:hardwareId"
                              element={<EvaraTankAnalytics />}
                            />
                            <Route
                              path="/evaradeep"
                              element={<EvaraDeepAnalytics />}
                            />
                            <Route
                              path="/evaradeep/:hardwareId"
                              element={<EvaraDeepAnalytics />}
                            />
                            <Route
                              path="/evaraflow"
                              element={<EvaraFlowAnalytics />}
                            />
                            <Route
                              path="/evaraflow/:hardwareId"
                              element={<EvaraFlowAnalytics />}
                            />
                            <Route
                              path="/evaratds/:id"
                              element={<EvaraTDSAnalytics />}
                            />
                            <Route
                              path="/evaramotor/:hardwareId"
                              element={<EvaraMotorAnalytics />}
                            />
                            <Route
                              path="/evaravalve/:hardwareId"
                              element={<EvaraValveAnalytics />}
                            />
                          ...
                          >
                            <Route path="/superadmin" element={<AdminLayout />}>
                              ...
                              />
                              <Route
                                path="zones/:regionId/customers"
                                element={<ZoneCustomers />}
                              />
