...
let meter = fs.readFileSync('client/src/components/dashboard/TDSMeterVisual.tsx', 'utf-8');
meter = meter.replace(/<<<<<<< HEAD[\s\S]*?=======\s*/g, '');
meter = meter.replace(/>>>>>>> 1fd25b56b42cbb9b72e3b965a3a1a5e5c692f020\s*/g, '');
fs.writeFileSync('client/src/components/dashboard/TDSMeterVisual.tsx', meter);

let card = fs.readFileSync('client/src/components/dashboard/TDSCard.tsx', 'utf-8');
...
fs.writeFileSync('client/src/components/dashboard/TDSCard.tsx', card);

let analytics = fs.readFileSync('client/src/pages/EvaraTDSAnalytics.tsx', 'utf-8');
analytics = analytics.replace(/<<<<<<< HEAD[\s\S]*?=======\s*/g, '');
analytics = analytics.replace(/>>>>>>> 1fd25b56b42cbb9b72e3b965a3a1a5e5c692f020\s*/g, '');
fs.writeFileSync('client/src/pages/EvaraTDSAnalytics.tsx', analytics);
